...
<div class="vh-100 border">
  <span class="user_profile" style="padding-left:1rem;">{{ $user->over_name }}</span><span class="user_profile">{{ $user->under_name }}さんのプロフィール</span>
      ...
      <div class="">
        ...
        <div class="subject_inner">
          <form class="d-flex" action="{{ route('user.edit') }}" method="post">
            ...
            @endforeach
            <input type="submit" value="編集" class="ml-3 btn btn-primary">
